# AI-Powered Research Outreach Automation

This project automates personalized research internship outreach emails to professors using **n8n**, **Google Sheets**, and an **AI Agent (LLM)**.
...
- Clean HTML email formatting (no duplication issues)  
